...
cols <- c("0" = "white", "1" = "blue", "2" = "darkgreen", "3" = "orange", "4" = "yellow", "5" = "Brown")
size_labs <- 6
face_font <- "plain"
...
file_name <- "../../../interim_documents/backups_google_docs/Ocean Solutions Tables_2017-05-16b.xlsx"
```
...
fig_t1a
ggsave(filename = "../figs/fig_t1a.png", plot = fig_t1a, width = 25, height = 25, units = "cm")
```
